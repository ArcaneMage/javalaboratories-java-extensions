...
import org.javalaboratories.core.function.Consumer14;
import org.javalaboratories.core.function.Function14;
...
public final class Tuple14<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13,T14> extends AbstractTuple {
     ...
     */
    public static <T> Maybe<Tuple14<T,T,T,T,T,T,T,T,T,T,T,T,T,T>> fromIterable(Iterable<T> iterable) {
     ...
     * {@code
     *      tuple
     *        .match(all("John","Wellington"), (a,b,c,d,e,f,g,h,i,j,k,l,m,n,o) -> System.out.println(a))
     *        .match(all("Alex","Wall",23), (a,b,c,d,e,f,g,h,i,j,k,l,m,n,o) -> System.out.println(b))
     * }
     * </pre>
