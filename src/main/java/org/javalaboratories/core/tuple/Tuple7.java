...
import org.javalaboratories.core.function.Consumer7;
import org.javalaboratories.core.function.Function7;
...
public final class Tuple7<T1,T2,T3,T4,T5,T6,T7> extends AbstractTuple {
     ...
     */
    public static <T> Maybe<Tuple7<T,T,T,T,T,T,T>> fromIterable(Iterable<T> iterable) {
     ...
     * {@code
     *      tuple
     *        .match(all("John","Wellington"), (a,b,c,d,e,f,g,h) -> System.out.println(a))
     *        .match(all("Alex","Wall",23), (a,b,c,d,e,f,g,h) -> System.out.println(b))
     * }
     * </pre>
