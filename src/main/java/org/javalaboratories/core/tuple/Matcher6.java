...
public final class Matcher6<T1,T2,T3,T4,T5,T6> extends AbstractMatcher {
    ...
    public static <T1,T2,T3,T4,T5,T6> Matcher6<T1,T2,T3,T4,T5,T6> any(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) { return new Matcher6<>(EnumSet.of(MATCH_ANY),t1,t2,t3,t4,t5,t6); }

    private Matcher6(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) {
        this(EnumSet.of(MATCH_ALL),t1,t2,t3,t4,t5,t6);
    }

    private Matcher6(Set<MatcherProperties> properties, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) {
        super(properties,t1,t2,t3,t4,t5,t6);
        this.t1 = t1;
        this.t2 = t2;
        this.t3 = t3;
        this.t4 = t4;
