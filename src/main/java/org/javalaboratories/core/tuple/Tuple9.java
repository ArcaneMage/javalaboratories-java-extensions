...
import org.javalaboratories.core.function.Consumer9;
import org.javalaboratories.core.function.Function9;
...
public final class Tuple9<T1,T2,T3,T4,T5,T6,T7,T8,T9> extends AbstractTuple {
     ...
     */
    public static <T> Maybe<Tuple9<T,T,T,T,T,T,T,T,T>> fromIterable(Iterable<T> iterable) {
     ...
     * {@code
     *      tuple
     *        .match(all("John","Wellington"), (a,b,c,d,e,f,g,h,i,j) -> System.out.println(a))
     *        .match(all("Alex","Wall",23), (a,b,c,d,e,f,g,h,i,j) -> System.out.println(b))
     * }
     * </pre>
     ...
     */
    public Tuple9<T2,T3,T4,T5,T6,T7,T8,T9,T1> rotateLeft1() {
        return rotateLeft(1);
    }
     ...
     */
    public Tuple9<T3,T4,T5,T6,T7,T8,T9,T1,T2> rotateLeft2() {
        return rotateLeft(2);
    }
     ...
     */
    public Tuple9<T4,T5,T6,T7,T8,T9,T1,T2,T3> rotateLeft3() {
        return rotateLeft(3);
    }
     ...
     */
    public Tuple9<T5,T6,T7,T8,T9,T1,T2,T3,T4> rotateLeft4() {
        return rotateLeft(4);
    }
     ...
     */
    public Tuple9<T6,T7,T8,T9,T1,T2,T3,T4,T5> rotateLeft5() {
        return rotateLeft(5);
    }
     ...
     */
    public Tuple9<T7,T8,T9,T1,T2,T3,T4,T5,T6> rotateLeft6() {
        return rotateLeft(6);
    }
     ...
     */
    public Tuple9<T8,T9,T1,T2,T3,T4,T5,T6,T7> rotateLeft7() {
        return rotateLeft(7);
    }
     ...
     */
    public Tuple9<T9,T1,T2,T3,T4,T5,T6,T7,T8> rotateLeft8() {
        return rotateLeft(8);
    }
