...
import com.excelsior.core.function.Consumer4;
...
public final class Tuple4<T1,T2,T3,T4> extends AbstractTuple {
     ...
     * {@code
     *      tuple
     *        .match(when("John","Wellington"), (a,b,c,d) -> System.out.println(a))
     *        .match(when("Alex","Wall",23), (a,b,c,d) -> System.out.println(b))
     * }
     * </pre>
