...
public final class Tuple11<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11> extends AbstractTuple {
     ...
     */
    public Tuple2<Tuple2<T1,T2>,Tuple9<T3,T4,T5,T6,T7,T8,T9,T10,T11>> splice2() { return splice(2); }

    /**
     * Splices this tuple into two partitions at element position 3
     */
    public Tuple2<Tuple3<T1,T2,T3>,Tuple8<T4,T5,T6,T7,T8,T9,T10,T11>> splice3() { return splice(3); }

    /**
     * Splices this tuple into two partitions at element position 4
     */
    public Tuple2<Tuple4<T1,T2,T3,T4>,Tuple7<T5,T6,T7,T8,T9,T10,T11>> splice4() { return splice(4); }

    /**
     * Splices this tuple into two partitions at element position 5
     */
    public Tuple2<Tuple5<T1,T2,T3,T4,T5>,Tuple6<T6,T7,T8,T9,T10,T11>> splice5() { return splice(5); }

    /**
     * Splices this tuple into two partitions at element position 6
     */
    public Tuple2<Tuple6<T1,T2,T3,T4,T5,T6>,Tuple5<T7,T8,T9,T10,T11>> splice6() { return splice(6); }

    /**
     * Splices this tuple into two partitions at element position 7
     */
    public Tuple2<Tuple7<T1,T2,T3,T4,T5,T6,T7>,Tuple4<T8,T9,T10,T11>> splice7() { return splice(7); }

    /**
     * Splices this tuple into two partitions at element position 8
     */
    public Tuple2<Tuple8<T1,T2,T3,T4,T5,T6,T7,T8>,Tuple3<T9,T10,T11>> splice8() { return splice(8); }

    /**
     * Splices this tuple into two partitions at element position 9
     */
    public Tuple2<Tuple9<T1,T2,T3,T4,T5,T6,T7,T8,T9>,Tuple2<T10,T11>> splice9() { return splice(9); }

    /**
     * Splices this tuple into two partitions at element position 10
     */
    public Tuple2<Tuple10<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10>,Tuple1<T11>> splice10() { return splice(10); }
