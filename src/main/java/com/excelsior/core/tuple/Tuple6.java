...
import com.excelsior.core.function.Consumer6;
import com.excelsior.core.function.Function6;
...
public final class Tuple6<T1,T2,T3,T4,T5,T6> extends AbstractTuple {
     ...
     * {@code
     *      tuple
     *        .match(when("John","Wellington"), (a,b,c,d,e,f,g) -> System.out.println(a))
     *        .match(when("Alex","Wall",23), (a,b,c,d,e,f,g) -> System.out.println(b))
     * }
     * </pre>
