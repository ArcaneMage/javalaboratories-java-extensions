...
import com.excelsior.core.function.Consumer15;
import com.excelsior.core.function.Function15;
...
public final class Tuple15<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13,T14,T15> extends AbstractTuple {
     ...
     * {@code
     *      tuple
     *        .match(when("John","Wellington"), (a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p) -> System.out.println(a))
     *        .match(when("Alex","Wall",23), (a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p) -> System.out.println(b))
     * }
     * </pre>
