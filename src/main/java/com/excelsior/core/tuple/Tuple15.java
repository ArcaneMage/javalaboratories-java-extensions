...
public final class Tuple15<T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13,T14,T15> extends AbstractTuple {
    ...
    public static <T> Nullable<Tuple15<T,T,T,T,T,T,T,T,T,T,T,T,T,T,T>> toTuple(Iterable<T> iterable) {
        @SuppressWarnings("unchecked")
        Nullable<Tuple15<T,T,T,T,T,T,T,T,T,T,T,T,T,T,T>> result = (Nullable<Tuple15<T,T,T,T,T,T,T,T,T,T,T,T,T,T,T>>) Tuple.toTuple(15,iterable);
        return result;
    }
