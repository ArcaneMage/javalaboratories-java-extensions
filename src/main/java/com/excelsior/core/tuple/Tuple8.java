...
public final class Tuple8<T1,T2,T3,T4,T5,T6,T7,T8> extends AbstractTuple {
    ...
    public static <T> Nullable<Tuple8<T,T,T,T,T,T,T,T>> toTuple(Iterable<T> iterable) {
        @SuppressWarnings("unchecked")
        Nullable<Tuple8<T,T,T,T,T,T,T,T>> result = (Nullable<Tuple8<T,T,T,T,T,T,T,T>>) Tuple.toTuple(8,iterable);
        return result;
    }
