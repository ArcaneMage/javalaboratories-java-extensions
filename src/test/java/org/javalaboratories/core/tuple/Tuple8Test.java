...
public class Tuple8Test {
    ...
    public void testAddAt_Pass() {
        Tuple9 tuple9 = tuple.addAt1("a");
        assertEquals(Tuple.of("a",1,2,3,4,5,6,7,8),tuple9);

        tuple9 = tuple.addAt2("a");
        assertEquals(Tuple.of(1,"a",2,3,4,5,6,7,8),tuple9);

        tuple9 = tuple.addAt3("a");
        assertEquals(Tuple.of(1,2,"a",3,4,5,6,7,8),tuple9);

        tuple9 = tuple.addAt4("a");
        assertEquals(Tuple.of(1,2,3,"a",4,5,6,7,8),tuple9);

        tuple9 = tuple.addAt5("a");
        assertEquals(Tuple.of(1,2,3,4,"a",5,6,7,8),tuple9);

        tuple9 = tuple.addAt6("a");
        assertEquals(Tuple.of(1,2,3,4,5,"a",6,7,8),tuple9);

        tuple9 = tuple.addAt7("a");
        assertEquals(Tuple.of(1,2,3,4,5,6,"a",7,8),tuple9);

        tuple9 = tuple.addAt8("a");
        assertEquals(Tuple.of(1,2,3,4,5,6,7,"a",8),tuple9);
    }

    @Test
    public void testHopTo_Pass() {
        Tuple8 tuple8 = tuple.hopTo1();
        assertEquals(Tuple.of(1,2,3,4,5,6,7,8), tuple8);

        Tuple7 tuple7 = tuple.hopTo2();
        assertEquals(Tuple.of(2,3,4,5,6,7,8), tuple7);

        Tuple6 tuple6 = tuple.hopTo3();
        assertEquals(Tuple.of(3,4,5,6,7,8), tuple6);

        Tuple5 tuple5 = tuple.hopTo4();
        assertEquals(Tuple.of(4,5,6,7,8), tuple5);

        Tuple4 tuple4 = tuple.hopTo5();
        assertEquals(Tuple.of(5,6,7,8), tuple4);

        Tuple3 tuple3 = tuple.hopTo6();
        assertEquals(Tuple.of(6,7,8), tuple3);

        Tuple2 tuple2 = tuple.hopTo7();
        assertEquals(Tuple.of(7,8), tuple2);

        Tuple1 tuple1 = tuple.hopTo8();
        assertEquals(Tuple.of(8), tuple1);
    }

    @Test
    public void testJoin_Pass() {
        Tuple8 aTuple8 = tuple.join(Tuple.of());
        ...
        assertEquals(Tuple.of(1,2,3,4,5,6,7,8,9),aTuple9_2);
    ...
    public void testFromIterable_Pass() {
        ...
        Maybe<Tuple8<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>>
    ...
    public void testSpliceAt_Pass() {
        Tuple2<Tuple0,Tuple8<Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer>>
                spliced1 = tuple.spliceAt1();
        assertEquals(2, spliced1.depth());
        assertEquals(0, spliced1.value1().depth());
        assertEquals(8, spliced1.value2().value8());
        ...
        assertEquals(8, spliced2.value2().value7());
        ...
        assertEquals(8, spliced3.value2().value6());
        ...
        assertEquals(8, spliced4.value2().value5());
        ...
        assertEquals(8, spliced5.value2().value4());
        ...
        assertEquals(8, spliced6.value2().value3());
        ...
        assertEquals(8, spliced7.value2().value2());

        Tuple2<Tuple7<Integer,Integer,Integer,Integer,Integer,Integer,Integer>,Tuple1<Integer>>
                spliced8 = tuple.spliceAt8();
        assertEquals(2, spliced8.depth());
        assertEquals(1, spliced8.value1().value1());
        assertEquals(8, spliced8.value2().value1());
    }

    @Test
    public void testRemove_Pass() {
        Tuple7 tuple7 = tuple.removeAt1();
        assertEquals(Tuple.of(2,3,4,5,6,7,8),tuple7);

        tuple7 = tuple.removeAt2();
        assertEquals(Tuple.of(1,3,4,5,6,7,8),tuple7);

        tuple7 = tuple.removeAt3();
        assertEquals(Tuple.of(1,2,4,5,6,7,8),tuple7);

        tuple7 = tuple.removeAt4();
        assertEquals(Tuple.of(1,2,3,5,6,7,8),tuple7);

        tuple7 = tuple.removeAt5();
        assertEquals(Tuple.of(1,2,3,4,6,7,8),tuple7);

        tuple7 = tuple.removeAt6();
        assertEquals(Tuple.of(1,2,3,4,5,7,8),tuple7);

        tuple7 = tuple.removeAt7();
        assertEquals(Tuple.of(1,2,3,4,5,6,8),tuple7);

        tuple7 = tuple.removeAt8();
    ...
    public void testMatch_Pass() {
        ...
        index.set(0);
        tuple.match(allOf(1,2,3,4,5,6,7,8), (a, b, c, d, e, f, g, h) -> index.incrementAndGet());
        tuple.match(anyOf(0,0,0,0,0,0,0,8), (a, b, c, d, e, f, g, h) -> index.incrementAndGet());
        tuple.match(setOf(8,7,6,5,4,3,2,1), (a, b, c, d, e, f, g, h) -> index.incrementAndGet());
