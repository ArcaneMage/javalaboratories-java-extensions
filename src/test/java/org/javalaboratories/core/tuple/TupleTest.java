...
public class TupleTest {
    ...
    public void testExamples_Pass() {
        ...
        Tuple3<String,Integer,Integer> tupleEarth = Tuple.of("Earth",7926,92955807);
        ...
        Tuple5<String,Integer,Integer,String,Integer> tupleEarthMoon = tupleEarth.join(Tuple.of("Moon",2159));
        ...
        Tuple7<String,String,String,String,String,String,String> tupleCoordinates = tupleEarth
                .truncateAt2()
                .addAt1("Milky Way")
                .join(Tuple.of("Europe","England","Blackfriars","London","EC2 1QW"));
        ...
        tupleEarth.match(Matcher.when("^Earth$"),(a, b, c) -> logger.info("Earth's distance from Sun {}",c));
