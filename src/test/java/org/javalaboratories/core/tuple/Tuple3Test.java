...
public class Tuple3Test {
    ...
    public void testFromIterable_Pass() {
        ...
        Maybe<Tuple3<Integer, Integer, Integer>>
    ...
    public void testRotateRight_Pass() {
        ...
        tuple3 = tuple.rotateRight1();
        assertEquals(Tuple.of(3,1,2),tuple3);

        tuple3 = tuple.rotateRight2();
        assertEquals(Tuple.of(2,3,1),tuple3);
    }

    @Test
    public void testRotateLeft_Pass() {
        Tuple3 tuple3 = tuple.rotateLeft1();
        assertEquals(Tuple.of(2,3,1),tuple3);

        tuple3 = tuple.rotateLeft2();
        assertEquals(Tuple.of(3,1,2),tuple3);
    }
    ...
    public void testMatch_Pass() {
        ...
        index.set(0);
        tuple.match(allOf(1,2,3), (a, b, c) -> index.incrementAndGet());
        tuple.match(anyOf(0,0,3), (a, b, c) -> index.incrementAndGet());
        tuple.match(setOf(3,2,1), (a, b, c) -> index.incrementAndGet());
