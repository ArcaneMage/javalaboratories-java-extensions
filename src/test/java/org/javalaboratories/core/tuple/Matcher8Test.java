...
public class Matcher8Test {
    private Matcher8<Integer,Integer,Integer,Integer,Integer,Integer,Integer,Integer> matcher;

    @BeforeEach
    public void setup() {
        matcher = Matcher.allOf(1,2,3,4,5,6,7,8);
    }
