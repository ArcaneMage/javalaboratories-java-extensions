...
public class Tuple5Test {
    ...
    public void testFromIterable_Pass() {
        ...
        Maybe<Tuple5<Integer, Integer, Integer, Integer, Integer>>
    ...
    public void testRemove_Pass() {
        Tuple4 tuple4 = tuple.removeAt1();
        assertEquals(Tuple.of(2,3,4,5),tuple4);

        tuple4 = tuple.removeAt2();
        assertEquals(Tuple.of(1,3,4,5),tuple4);

        tuple4 = tuple.removeAt3();
        assertEquals(Tuple.of(1,2,4,5),tuple4);

        tuple4 = tuple.removeAt4();
        assertEquals(Tuple.of(1,2,3,5),tuple4);

        tuple4 = tuple.removeAt5();
    ...
    public void testMatch_Pass() {
        ...
        index.set(0);
        tuple.match(allOf(1,2,3,4,5), (a, b, c, d, e) -> index.incrementAndGet());
        tuple.match(anyOf(0,0,0,0,5), (a, b, c, d, e) -> index.incrementAndGet());
        tuple.match(setOf(5,4,3,2,1), (a, b, c, d, e) -> index.incrementAndGet());
