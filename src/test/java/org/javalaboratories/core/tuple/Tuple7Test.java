...
public class Tuple7Test {
    ...
    public void testFromIterable_Pass() {
        ...
        Maybe<Tuple7<Integer, Integer, Integer, Integer, Integer, Integer, Integer>>
    ...
    public void testRemove_Pass() {
        Tuple6 tuple6 = tuple.removeAt1();
        assertEquals(Tuple.of(2,3,4,5,6,7),tuple6);

        tuple6 = tuple.removeAt2();
        assertEquals(Tuple.of(1,3,4,5,6,7),tuple6);

        tuple6 = tuple.removeAt3();
        assertEquals(Tuple.of(1,2,4,5,6,7),tuple6);

        tuple6 = tuple.removeAt4();
        assertEquals(Tuple.of(1,2,3,5,6,7),tuple6);

        tuple6 = tuple.removeAt5();
        assertEquals(Tuple.of(1,2,3,4,6,7),tuple6);

        tuple6 = tuple.removeAt6();
        assertEquals(Tuple.of(1,2,3,4,5,7),tuple6);

        tuple6 = tuple.removeAt7();
    ...
    public void testRotateRight_Pass() {
        ...
        tuple7 = tuple.rotateRight1();
        assertEquals(Tuple.of(7,1,2,3,4,5,6),tuple7);

        tuple7 = tuple.rotateRight2();
        assertEquals(Tuple.of(6,7,1,2,3,4,5),tuple7);

        tuple7 = tuple.rotateRight3();
        assertEquals(Tuple.of(5,6,7,1,2,3,4),tuple7);

        tuple7 = tuple.rotateRight4();
        assertEquals(Tuple.of(4,5,6,7,1,2,3),tuple7);

        tuple7 = tuple.rotateRight5();
        assertEquals(Tuple.of(3,4,5,6,7,1,2),tuple7);

        tuple7 = tuple.rotateRight6();
        assertEquals(Tuple.of(2,3,4,5,6,7,1),tuple7);
    }

    @Test
    public void testRotateLeft_Pass() {
        Tuple7 tuple7 = tuple.rotateLeft1();
        assertEquals(Tuple.of(2,3,4,5,6,7,1),tuple7);

        tuple7 = tuple.rotateLeft2();
        assertEquals(Tuple.of(3,4,5,6,7,1,2),tuple7);

        tuple7 = tuple.rotateLeft3();
        assertEquals(Tuple.of(4,5,6,7,1,2,3),tuple7);

        tuple7 = tuple.rotateLeft4();
        assertEquals(Tuple.of(5,6,7,1,2,3,4),tuple7);

        tuple7 = tuple.rotateLeft5();
        assertEquals(Tuple.of(6,7,1,2,3,4,5),tuple7);

        tuple7 = tuple.rotateLeft6();
        assertEquals(Tuple.of(7,1,2,3,4,5,6),tuple7);
    }
    ...
    public void testMatch_Pass() {
        ...
        index.set(0);
        tuple.match(allOf(1,2,3,4,5,6,7), (a, b, c, d, e, f, g) -> index.incrementAndGet());
        tuple.match(anyOf(0,0,0,0,0,0,7), (a, b, c, d, e, f, g) -> index.incrementAndGet());
        tuple.match(setOf(7,6,5,4,3,2,1), (a, b, c, d, e, f, g) -> index.incrementAndGet());
